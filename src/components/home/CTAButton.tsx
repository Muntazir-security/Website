...
const CTAButton = ({ href, text, icon: Icon }: CTAButtonProps) => (
  <Link to={href}>
    <button className="group relative w-[160px]">
      <div className="absolute -inset-0.5 bg-gradient-to-r from-cyber-teal to-secondary rounded-xl opacity-50 blur-md group-hover:opacity-90 transition-all duration-700"></div>
