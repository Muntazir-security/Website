...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden" id="Home">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="h-8 flex items-center" data-aos="fade-up" data-aos-delay="800">
                  <span className="text-xl md:text-2xl text-foreground/80 font-light">
                    {text}
                  </span>
                ...
                {/* Description */}
                <p className="text-base md:text-lg text-foreground/60 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
